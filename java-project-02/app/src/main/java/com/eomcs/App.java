...
public class App {
  static final int BOARD_LENTH = 100;
  static String[] titles = new String[BOARD_LENTH];
  static String[] contents = new String[BOARD_LENTH];
  static String[] passwords = new String[BOARD_LENTH];
  static int[] viewCounts = new int[BOARD_LENTH];
  static Date[] createdDates = new Date[BOARD_LENTH];
  static int size = 0;
